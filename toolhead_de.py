...
import mcu, chelper, kinematics.extruder_de_de
...
class ToolHead:
    def __init__(self, config):
        ...
        extruder = kinematics.extruder_de.DummyExtruder(self.printer)
...
def add_printer_objects(config):
    ...
    kinematics.extruder_de.add_printer_objects(config)
