...
# Modified 2026 by Domingos Rodrigues <domingoslamas@gmail.com> included customizable Z tilt position
#
...
class ZTilt_DE:
    def __init__(self, config):
        ...
        self.probe_helper_points_backup = self.probe_helper.probe_points
    ...
    def cmd_Z_TILT_ADJUST(self, gcmd):
        # Get new z tilt positions from command if they exist
        self.p1_x = gcmd.get_float('P1_X', -999,minval=-999, maxval=500)
        self.p1_y = gcmd.get_float('P1_Y', -999,minval=-999, maxval=500)
        self.p2_x = gcmd.get_float('P2_X', -999,minval=-999, maxval=500)
        self.p2_y = gcmd.get_float('P2_Y', -999,minval=-999, maxval=500)
        self.p3_x = gcmd.get_float('P3_X', -999,minval=-999, maxval=500)
        self.p3_y = gcmd.get_float('P3_Y', -999,minval=-999, maxval=500)

        if( self.p1_x != -999 and self.p1_y != -999 and self.p2_x != -999 and self.p2_y != -999 and self.p3_x != -999 and self.p3_y != -999):
            self.probe_helper.probe_points = [[self.p1_x,self.p1_y],[self.p2_x,self.p2_y],[self.p3_x,self.p3_y]]
        else:
            self.probe_helper.probe_points = self.probe_helper_points_backup
